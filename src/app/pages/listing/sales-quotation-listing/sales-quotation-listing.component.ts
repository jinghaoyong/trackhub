...
@Component({
  selector: 'app-sales-quotation-listing',
  templateUrl: './sales-quotation-listing.component.html',
  styleUrls: ['./sales-quotation-listing.component.scss'],
  providers: [SalesQuotationService, DecimalPipe]
})
export class SalesQuotationListingComponent {
// bread crumb items
